...
export default function AuroraGraphic({
  colorStops = ["#6f7a52", "#c99a4a", "#23291f"],
  amplitude = 0.9,
  blend = 0.55,
  speed = 0.55,
}) {
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: colorStops.map(toRgbTriplet) },
    ...
    const render = (time) => {
      ...
      program.uniforms.uColorStops.value = colorStops.map(toRgbTriplet);
